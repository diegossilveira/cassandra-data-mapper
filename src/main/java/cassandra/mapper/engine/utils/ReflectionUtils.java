...
public abstract class ReflectionUtils {
	...
	public static <T> Object getFieldValue(Field field, T object) {
		...
		try {
			...
			throw new CassandraEngineException(String.format("Can't get the value (%s) for class '%s'",
					field.getName(), object.getClass().getCanonicalName()), ex);
		}
	}
	...
	public static <T> T instantiate(Class<T> type) {
		...
		try {
			...
			throw new CassandraEngineException(String.format("Can't instantiate an object of type '%s'",
